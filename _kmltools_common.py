...
class KmlParser:
	...
	def __init__(self, filename: str):
		...
		with open(filename) as f:
			...
			self.root_node = xmltodict.parse(f.read())
	...
	def kml_split(self) -> list[dict]:
		...
		for i, placemark_node in enumerate(placemark_nodes):
			...
			new_root_node["kml"]["Document"]["name"] = document_name + f"_{i}"
	...
	def to_gpx(self) -> dict:
		...
		import json
		print(json.dumps(gpx_node, indent=2))
	...
	def write(self, basename: str, xml_node: dict = None, extension="kml") -> str:
